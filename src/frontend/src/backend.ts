...
import type { Lead as _Lead, Product as _Product, ProductId as _ProductId, ProductType as _ProductType, StripeSessionStatus as _StripeSessionStatus, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createLead(arg0: string, arg1: string, arg2: ProductId, arg3: string): Promise<Lead> {
        if (this.processError) {
            try {
    ...
    async upsertFAQ(arg0: FAQ): Promise<FAQ> {
        if (this.processError) {
            try {
                const result = await this.actor.upsertFAQ(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Lead]): Lead | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_variant_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "Playbook" in value ? ProductType.Playbook : "Guide" in value ? ProductType.Guide : "Compendium" in value ? ProductType.Compendium : "Handbook" in value ? ProductType.Handbook : "Framework" in value ? ProductType.Framework : value;
}
