          ...
          <div className="flex items-start justify-between gap-3">
            <span
              className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold border ${
                TYPE_COLORS[product.productType] ?? "bg-primary/15 text-primary border-primary/30"
...
function FAQSection() {
  ...
  return (
    <section id="support" className="py-24 bg-card/50 border-t border-border/40" data-ocid="support.section">
...
export default function Home() {
  ...
  const products =
    backendProducts && backendProducts.length > 0 ? backendProducts : PLACEHOLDER_PRODUCTS;
  ...
  return (
    <Layout>
      {/* Hero */}
      <section className="relative overflow-hidden bg-background" data-ocid="hero.section">
        <div
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-28 text-center">
          ...
          >
            Precision-crafted compendiums, frameworks, playbooks, guides, and handbooks for executives, managers, consultants, and coaches who refuse to settle for average.
          </motion.p>
      ...
      {/* Products */}
      <section id="products" className="py-24 bg-background" data-ocid="products.section">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-3 text-muted-foreground max-w-xl mx-auto">
              Curated tools for leaders who operate at the highest level. Each resource is engineered for real-world application and lasting impact.
            </p>
          </motion.div>
      ...
      {/* Closing CTA */}
      <section className="py-24 bg-background border-t border-border/40" data-ocid="cta.section">
        <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              Every resource in the Vanguard Executives collection is designed to move you from insight to impact. The next level of your leadership journey starts here.
            </p>
            <Button
              type="button"
              onClick={scrollToProducts}
